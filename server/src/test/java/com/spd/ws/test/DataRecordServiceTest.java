...
//	private String basicUrl = "http://172.24.176.84:8080/server/services";
	...
	@Test
	public void testRecordByTimes() throws Exception {
		String url = basicUrl + "/DataRecordService/";
		testPost(url, "recordByTimes", "para", "{\"startTime\":\"2016-10-01\", \"endTime\":\"2016-10-21\"}");
