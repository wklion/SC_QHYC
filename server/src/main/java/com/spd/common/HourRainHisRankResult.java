 ...
 *
 */
public class HourRainHisRankResult {
	// 站号
	...
	public String getHisExtTime() {
		return hisExtTime;
	}
	public void setHisExtTime(String hisExtTime) {
		this.hisExtTime = hisExtTime;
	}
