 ...
 *
 */
public class WinAvgHourDaoImpl extends BaseDao {
	
	private String QUERYSNOWSTRUCT = "select * from t_WinAvg2MinHour where 1=2";

	private String ADDSDATA = "insert into t_WinAvg2MinHour (%s) values (%s)";
	
	public HashMap<String, Object> getExistData(String datetime) {
		//mysql
		String query = "select Station_Id_C, date_format(datetime, '%Y-%m-%d') as datetime, Hours from t_WinAvg2MinHour where datetime = '" + datetime + "'";		
