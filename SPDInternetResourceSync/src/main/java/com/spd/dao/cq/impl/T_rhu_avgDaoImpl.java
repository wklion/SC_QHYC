 ...
 *
 */
public class T_rhu_avgDaoImpl extends BaseDao {

	private int year;
	
	private String QUERYEXISTDATA = "select Station_Id_C, year, id from t_rhu_avg where year = ";

	private String UPDATEDATA = "update t_rhu_avg set %columns = ? where id = ?";
	
	private String INSERTDATA = "insert into t_rhu_avg (%s) values (%s) ";
	
	private String QUERYSURFCHNMULSTRUCT = "select * from t_rhu_avg where 1=2";

	public T_rhu_avgDaoImpl(int year) {
		this.year = year;
