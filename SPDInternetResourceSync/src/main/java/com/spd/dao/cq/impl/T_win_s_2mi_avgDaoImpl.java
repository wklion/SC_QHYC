 ...
 *
 */
public class T_win_s_2mi_avgDaoImpl extends BaseDao {

	private int year;
	
	private String QUERYEXISTDATA = "select Station_Id_C, year, id from t_win_s_2mi_avg where year = ";

	private String UPDATEDATA = "update t_win_s_2mi_avg set %columns = ? where id = ?";
	
	private String INSERTDATA = "insert into t_win_s_2mi_avg (%s) values (%s) ";
	
	private String QUERYSURFCHNMULSTRUCT = "select * from t_win_s_2mi_avg where 1=2";
	
	public T_win_s_2mi_avgDaoImpl(int year) {
		this.year = year;
