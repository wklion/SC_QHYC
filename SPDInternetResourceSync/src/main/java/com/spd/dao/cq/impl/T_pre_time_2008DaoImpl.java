 ...
 *
 */
public class T_pre_time_2008DaoImpl extends BaseDao {

	private int year;
	
	private String QUERYEXISTDATA = "select Station_Id_C, year, id from t_pre_time_2008 where year = ";

	private String UPDATEDATA = "update t_pre_time_2008 set %columns = ? where id = ?";
	
	private String INSERTDATA = "insert into t_pre_time_2008 (%s) values (%s) ";
	
	private String QUERYSURFCHNMULSTRUCT = "select * from t_pre_time_2008 where 1=2";
	
	public T_pre_time_2008DaoImpl(int year) {
		this.year = year;
