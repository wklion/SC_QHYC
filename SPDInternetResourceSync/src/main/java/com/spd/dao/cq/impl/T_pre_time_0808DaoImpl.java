 ...
 *
 */
public class T_pre_time_0808DaoImpl extends BaseDao {

	private int year;
	
	private String QUERYEXISTDATA = "select Station_Id_C, year, id from t_pre_time_0808 where year = ";

	private String UPDATEDATA = "update t_pre_time_0808 set %columns = ? where id = ?";
	
	private String INSERTDATA = "insert into t_pre_time_0808 (%s) values (%s) ";
	
	private String QUERYSURFCHNMULSTRUCT = "select * from t_pre_time_0808 where 1=2";
	

	public T_pre_time_0808DaoImpl(int year) {
		this.year = year;
