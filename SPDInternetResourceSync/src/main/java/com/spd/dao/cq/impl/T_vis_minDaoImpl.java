 ...
 *
 */
public class T_vis_minDaoImpl extends BaseDao {

	private int year;
	
	private String QUERYEXISTDATA = "select Station_Id_C, year, id from t_vis_min where year = ";

	private String UPDATEDATA = "update t_vis_min set %columns = ? where id = ?";
	
	private String INSERTDATA = "insert into t_vis_min (%s) values (%s) ";
	
	private String QUERYSURFCHNMULSTRUCT = "select * from t_vis_min where 1=2";

	public T_vis_minDaoImpl(int year) {
		this.year = year;
