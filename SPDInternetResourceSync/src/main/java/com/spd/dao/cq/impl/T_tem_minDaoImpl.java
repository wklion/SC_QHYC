 ...
 *
 */
public class T_tem_minDaoImpl extends BaseDao {

	private int year;
	
	private String QUERYEXISTDATA = "select Station_Id_C, year, id from t_tem_min where year = ";

	private String UPDATEDATA = "update t_tem_min set %columns = ? where id = ?";
	
	private String INSERTDATA = "insert into t_tem_min (%s) values (%s) ";
	
	private String QUERYSURFCHNMULSTRUCT = "select * from t_tem_min where 1=2";

	public T_tem_minDaoImpl(int year) {
		this.year = year;
