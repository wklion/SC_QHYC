 ...
 *
 */
public class T_tem_maxDaoImpl extends BaseDao {

	private int year;
	
	private String QUERYEXISTDATA = "select Station_Id_C, year, id from t_tem_max where year = ";

	private String UPDATEDATA = "update t_tem_max set %columns = ? where id = ?";
	
	private String INSERTDATA = "insert into t_tem_max (%s) values (%s) ";
	
	private String QUERYSURFCHNMULSTRUCT = "select * from t_tem_max where 1=2";

	public T_tem_maxDaoImpl(int year) {
		this.year = year;
